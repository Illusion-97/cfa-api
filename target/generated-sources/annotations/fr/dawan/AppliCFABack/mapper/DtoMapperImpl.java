...
public class DtoMapperImpl implements DtoMapper {
    ...
    @Override
    public DossierProjetEtudiantDto dossierProjetToDossierProjetDto(DossierProjet dossierProjet) {
    ...
    protected DossierProjetDto dossierProjetToDossierProjetDto1(DossierProjet dossierProjet) {
        if ( dossierProjet == null ) {
            return null;
        }
    ...
    protected List<DossierProjetDto> dossierProjetListToDossierProjetDtoList(List<DossierProjet> list) {
        ...
        for ( DossierProjet dossierProjet : list ) {
            list1.add( dossierProjetToDossierProjetDto1( dossierProjet ) );
        }
