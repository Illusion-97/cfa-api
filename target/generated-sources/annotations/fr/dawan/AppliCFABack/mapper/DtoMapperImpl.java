...
public class DtoMapperImpl implements DtoMapper {
    ...
    public TuteurDto tuteurTotuteurDto(Tuteur tuteur) {
        ...
        tuteurDto.setUtilisateurDto( utilisateurToUtilisateurDto( tuteur.getUtilisateur() ) );
    ...
    public SoutenanceDto soutenanceToSoutenanceDto(Soutenance soutenance) {
        ...
        soutenanceDto.setExamDate( soutenance.getExamDate() );
    ...
    public Soutenance soutenanceDtoToSoutenance(SoutenanceDto soutenanceDto) {
        ...
        soutenance.setExamDate( soutenanceDto.getExamDate() );
