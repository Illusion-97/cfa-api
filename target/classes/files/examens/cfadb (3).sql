...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 03 mai 2022 à 13:43
...
INSERT INTO `absence` (`id`, `date_debut`, `date_fin`, `justificatif`, `etudiant_id`, `type_absence`, `version`, `intervention_id`) VALUES
(1, '2021-10-25', '2021-10-25', 'justificatif', 1, NULL, 0, NULL);
...
(1, 'Bordeaux', NULL, NULL, 'FR', 1),
(2, 'Lille', NULL, NULL, 'FR', 2),
(3, 'Lyon', NULL, NULL, 'FR', 3),
(4, 'Marseille', NULL, NULL, 'FR', 4),
(5, 'Montpellier', NULL, NULL, 'FR', 5),
(6, 'Nantes', NULL, NULL, 'FR', 6),
(7, 'Paris', NULL, NULL, 'FR', 7),
(8, 'Rennes', NULL, NULL, 'FR', 8),
(9, 'Strasbourg (OLD)', NULL, NULL, 'FR', 9),
(10, 'Toulouse', NULL, NULL, 'FR', 10),
(11, 'Sur site', NULL, NULL, 'FR', 11),
(12, 'Nice', NULL, NULL, 'FR', 12),
(13, 'Bruxelles', NULL, NULL, 'BE', 13),
(14, 'Luxembourg', NULL, NULL, 'LU', 14),
(15, 'Geneve', NULL, NULL, 'CH', 15),
(16, 'Distance', NULL, NULL, 'FR', 17),
(17, 'Aix en Provence', NULL, NULL, 'FR', 21),
(18, 'Amiens', NULL, NULL, 'FR', 23),
(19, 'France entière', NULL, NULL, 'FR', 25),
(20, 'Paris 2', NULL, NULL, 'FR', 27),
(21, 'Nantes 2', NULL, NULL, 'FR', 28),
(22, 'Strasbourg', NULL, NULL, 'FR', 29);
...
INSERT INTO `cursus` (`id`, `titre`, `description`, `duree`) VALUES
(1, 'CDA', NULL, 0),
(2, 'titre cursus 1', NULL, 0),
(3, 'titre cursus 2', NULL, 0);
...
INSERT INTO `devoir` (`id`, `date_debut`, `date_fin`, `enonce`, `intervention_id`, `consigne`, `version`) VALUES
(2, NULL, NULL, '', 1, '', 0);
...
INSERT INTO `devoir_etudiant` (`id`, `date_rendu`, `piece_jointe`, `devoir_id`, `etudiant_id`) VALUES
(1, '2022-04-20 09:24:04', 'k,,kml', 2, 1),
(2, '2022-04-20 09:24:04', 'REAC_CDA_V03_03052018 (4).pdf', 2, 1);
...
CREATE TABLE IF NOT EXISTS `examen` (
  ...
  `activite_types_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKcu3jbla2430ilxs1vtroa8wnx` (`promotion_id`),
  KEY `FKd8rm5os59glgwtesprnfa2w6j` (`activite_types_id`)
...
INSERT INTO `examen` (`id`, `date_examen`, `descriptif`, `duree`, `piece_jointe`, `titre`, `promotion_id`, `activite_types_id`) VALUES
(1, '2022-05-11 00:00:00', 'QCM Java', 5, 'BIASAL_1_Feres.pdf', 'Java', 1, NULL),
(3, '2022-03-17 15:56:24', 'Java Approfondissement1 ', 5.5, 'Url=>pieceJointe', 'Java1', 12, NULL),
(4, '2022-03-17 15:56:24', 'Java Approfondissement ', 5.5, 'Url=>pieceJointe', 'Java', 1, NULL),
(64, '2023-03-16 00:00:00', 'ladernièreFormation', 8, 'REAC_CDA_V03_03052018 (6).pdf', 'Examen', 1, NULL),
(65, '2023-03-16 00:00:00', 'ladernièreFormation', 8, 'REAC_CDA_V03_03052018 (6).pdf', 'ExamenTEst', 1, NULL),
(66, '2023-03-16 00:00:00', 'ladernièreFormation', 8, 'REAC_CDA_V03_03052018 (6).pdf', 'ExamenTEst', 1, NULL),
(67, '2023-03-16 00:00:00', 'ladernièreFormation', 8, 'REAC_CDA_V03_03052018 (6).pdf', 'ExamenTEst', 1, NULL),
(68, '2023-03-16 00:00:00', 'ladernièreFormation', 8, 'REAC_CDA_V03_03052018 (6).pdf', 'ExamenTEst', 1, NULL);
...
CREATE TABLE IF NOT EXISTS `examen_activite_types` (
  ...
  KEY `FK5b2y6h8ea5kofnd5cwywmbwda` (`examen_id`)
...
INSERT INTO `examen_activite_types` (`examen_id`, `activite_types_id`) VALUES
(4, 4),
(4, 7),
(1, 4),
(1, 7),
...
(4, '', 'Spring MVC', '', 4, ''),
(5, NULL, 'Titre professionnel Administrateur d\'infrastructures sécurisées (TP-01352m01)', '100.00', 101232, 'titre-professionnel-administrateur-d-infrastructures-securisees-tp-01352m01'),
(6, NULL, 'Titre professionnel Assistant(e) commercial(e) (TP-01285m02)', '100.00', 101234, 'titre-professionnel-assistant-e-commercial-e-tp-01285m02'),
(7, NULL, 'Titre professionnel BIM modeleur du batîment (TP-01361m01)', '100.00', 101230, 'titre-professionnel-bim-modeleur-du-batiment-tp-01361m01'),
(8, NULL, 'Titre professionnel Concepteur Designer UI (TP-01411m01)', '100.00', 101503, 'titre-professionnel-concepteur-designer-ui-tp-01411m01'),
(9, NULL, 'Titre professionnel Concepteur Développeur d\'Applications (TP-01281m03)', '100.00', 101229, 'titre-professionnel-concepteur-developpeur-d-applications-tp-01281m03'),
(10, NULL, 'Titre professionnel Designer Web (TP-00469m05)', '100.00', 101184, 'titre-professionnel-designer-web-tp-00469m05'),
(11, NULL, 'Titre professionnel Développeur web et web mobile (TP-01280m03)', '100.00', 101235, 'titre-professionnel-developpeur-web-et-web-mobile-tp-01280m03'),
(12, NULL, 'Titre professionnel Formateur professionnel d\'adultes (TP-00350m06)', '100.00', 101233, 'titre-professionnel-formateur-professionnel-d-adultes-tp-00350m06'),
(13, NULL, 'Titre professionnel Monteur / monteuse audiovisuel (TP-01236m04))', '100.00', 101236, 'titre-professionnel-monteur-monteuse-audiovisiuel-tp-01236m04'),
(14, NULL, 'Titre professionnel Négociateur technico-commercial (TP-00338m8)', '100.00', 101266, 'titre-professionnel-negociateur-technico-commercial-tp-00338m8'),
(15, NULL, 'Titre professionnel Technicien d\'assistance en informatique (TP-00476m07)', '80.00', 101193, 'titre-professionnel-technicien-d-assistance-en-informatique-tp-00476m07'),
(16, NULL, 'Titre professionnel Technicien supérieur systèmes et réseaux (TP-01351m01)', '100.00', 101231, 'titre-professionnel-technicien-superieur-systemes-et-reseaux-tp-01351m01');
...
INSERT INTO `note` (`id`, `note_obtenue`, `etudiant_note_id`, `examen_id`, `satisfaction`) VALUES
(1, 16.5, 1, 4, 'OUI'),
(2, 16.5, 2, 4, 'OUI'),
(3, 8.5, 3, 4, 'NON'),
(13, 17, 4, 4, 'OUI'),
...
INSERT INTO `positionnement` (`id`, `niveau_debut`, `niveau_fin`, `version`, `etudiant_id`, `intervention_id`) VALUES
(1, 'AUCUNECONNAISSANCE', 'ENCOURSDACQUISITION', 0, 1, 1),
(2, 'AUCUNECONNAISSANCE', 'ENCOURSDACQUISITION', 0, 2, 1);
...
INSERT INTO `signature` (`id`, `piece_jointe`, `version`, `utilisateur_id`) VALUES
(1, 'Rien', 0, 1),
(2, '76019AUWT72924892981220413025015985782206 (2).pdf', 0, NULL),
(3, '76019AUWT72924892981220413025015985782206 (2).pdf', 0, NULL);
...
--
ALTER TABLE `absence`
  ADD CONSTRAINT `FKpe2bp7xjf8m5ifyurasjxto7j` FOREIGN KEY (`intervention_id`) REFERENCES `intervention` (`id`),
...
ALTER TABLE `examen`
  ...
  ADD CONSTRAINT `FKd8rm5os59glgwtesprnfa2w6j` FOREIGN KEY (`activite_types_id`) REFERENCES `activite_type` (`id`);

--
-- Contraintes pour la table `examen_activite_types`
--
ALTER TABLE `examen_activite_types`
  ADD CONSTRAINT `FK5b2y6h8ea5kofnd5cwywmbwda` FOREIGN KEY (`examen_id`) REFERENCES `examen` (`id`),
