    ...
    <img src="capture.png" alt="image convocation"/>
        ...
        <div class="presentation">
            ...
            <div>
                ...
                <p style="margin-top: 17%;"> ${tDto.jour} Le 12 juillet 2023,</p>
            </div>
        </div>

        <h3>
            <b><u>Objet :</u> 
            Convocation à la session d’examen du ${tDto.jour} 12 septembre 2023 pour le Titre professionnel
        ...
        <div>
            ...
            <p>
                ...
                <h3 style="margin-left: 3%;">➢ Le ${tDto.jour} 12 septembre 2023 à ${tDto.heure} au {{}} 250 avenue Emile Counord, {{}} 33000 BORDEAUX</h3>

                Le déroulé de l’examen est le suivant : <br/>
                - Mise en situation professionnelle à {{}} 9h00 (durée : 4h00) : Réalisation d’un montage.

                <h3 style="margin-left: 3%;"> ➢ Le ${tDto.jour} 12 septembre 2023 à 16h05 au {{}} 250 avenue Emile Counord, {{}} 33000 BORDEAUX</h3>
                
                <p>Le déroulé de l’examen est le suivant :</p>
                
                - Accueil et entretien technique de ${tDto.minAccueil} 16h20 – ${tDto.minEntretien} 17h05 (durée : 5mn + 40mn) : Présentation du montage réalisé
                lors de la mise en situation + questions techniques. <br/>
                - Questionnement à partir de production de ${tDto.minQuestion} 17h05 – ${tDto.minEntretienFinal} 17h55 (durée : 50mn) : Questions des jurys sur des
                montages réalisés en amont. <br/>
                - Entretien final de ${tDto.minEntretienFinal} 17h55 – ${tDto.minDeliberation} 18h25 (durée : 30mn) : Discussion sur le Dossier Professionnel, la vision et la
