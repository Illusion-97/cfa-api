...
public interface DtoMapper {
    ...
    default int dateFormationReel(LocalDate dateEntree, LocalDate dateFin){
    ...
    @Mapping(source = "dureeMoisFormationReelle", target = "dureeMoisFormationReelle", qualifiedByName = ("dateFormationReel"))
    ...
    @Mapping(source = "dureeMoisFormationReelle", target = "dureeMoisFormationReelle", qualifiedByName = ("dureeMoisFormationReelle"))
