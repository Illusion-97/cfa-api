...
public interface FormateurRepository extends JpaRepository<Formateur, Long> {
	...
	long countByPersonnePrenomContainingOrPersonneNomContainingAllIgnoreCase(String prenom, String nom);

	// liste des formateur + recherche par mot clé
	Page<Formateur> findAllByPersonnePrenomContainingOrPersonneNomContainingAllIgnoreCase(String prenom, String nom, Pageable p);
