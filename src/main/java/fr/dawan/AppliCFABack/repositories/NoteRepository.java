...
public interface NoteRepository extends JpaRepository<Note, Long>{
	...
	Page<Note> findAllByEtudiantPersonnePrenomContainingIgnoringCaseOrEtudiantPersonneNomContainingIgnoringCaseOrExamenExamenEnonceContainingIgnoringCaseOrDevoirEnonceContainingIgnoringCase(
			String search, String search2, String search3, String search4, Pageable pageable);

	long countByEtudiantPersonnePrenomContainingIgnoringCaseOrEtudiantPersonneNomContainingIgnoringCaseOrExamenExamenEnonceContainingIgnoringCaseOrDevoirEnonceContainingIgnoringCase(
