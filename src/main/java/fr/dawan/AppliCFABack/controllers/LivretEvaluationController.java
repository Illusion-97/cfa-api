...
public class LivretEvaluationController extends GenericController<LivretEvaluationDto>{
	...
	@GetMapping(value = "/generer/{idEtudiant}",  produces = "application/octet-stream")
	public ResponseEntity<Resource> getGrillePositionnement(@PathVariable("idEtudiant") long idEtudiant) throws Exception {
		
		String outpoutPath = ((LivretEvaluationService) service).getLivretEvaluation(idEtudiant);
