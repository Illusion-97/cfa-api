...
import fr.dawan.AppliCFABack.services.dg2Imports.DG2ImportInterventions;
...
public class InterventionController {
	...
	private final DG2ImportInterventions dg2ImportInterventions;
	...
	public InterventionController(
			...
			@Autowired DG2ImportInterventions dg2ImportInterventions
	) {
		this.interventionService = interventionService;
		this.filesService = filesService;
		this.dg2ImportInterventions = dg2ImportInterventions;
	}
	...
	public ResponseEntity<String> fetchAllDG2(@RequestHeader Map<String, String> headers) {
		...
		try {
			dg2ImportInterventions.fetchDGInterventions(splitUser[0], splitUser[1]);
	...
	@GetMapping(value =  "/dg2/{idPromotion}", produces="application/json")
	public ResponseEntity<String> fetchDG2InterventionsByPromotionId(
			@RequestHeader Map<String, String> headers,
			@PathVariable(value = "idPromotion") Long idPromotion ) {
		String userDG2 = headers.get("x-auth-token");
		String[] splitUser = userDG2.split(":");

		try {
			dg2ImportInterventions.fetchDGInterventions(splitUser[0], splitUser[1], idPromotion);
			return ResponseEntity.status(HttpStatus.OK).body("Succeed to fetch data from the webservice DG2. Interventions updated");
		} catch (Exception e) {
			logger.error("Exception", e);
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
